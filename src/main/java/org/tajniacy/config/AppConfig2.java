...
public class AppConfig2 implements WebMvcConfigurer {
    ...
    Properties additionalProperties() {
        ...
        properties.setProperty("hibernate.hbm2ddl.auto", "update"); //drop-and-create
        properties.setProperty("hibernate.dialect", "org.hibernate.dialect.MySQL5InnoDBDialect");
        properties.setProperty("hibernate.show_sql", "false"); //  zmieniłem z true na false, zeby nie widzieć zapytań do DB
        properties.setProperty("hibernate.format_sql", "false"); //  zmieniłem z true na false, zeby nie widzieć zapytań do DB
        return properties;
    }
